...
public class Triangulator {
	...
	public int[] TriangulatePolygon(Vector2[] XZofVertices)
	{
		...
		ExpandedXZ[VertexCount] = new Vector2((xmid - 8f * dmax), (ymid - dmax));
		ExpandedXZ[VertexCount + 1] = new Vector2(xmid, (ymid + 8f * dmax));
		ExpandedXZ[VertexCount + 2] = new Vector2((xmid + 8f * dmax), (ymid - dmax));
